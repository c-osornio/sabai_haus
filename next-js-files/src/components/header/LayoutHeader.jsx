        ...
        <div className="container-lg container-fluid">
          <div className="row">
            <div className="col-12 d-flex align-items-center justify-content-between">
              ...
              <div
                className={
                  showMobileMenu === 1 ? "main-menu show-menu" : "main-menu"
                }
              >
                <div className="mobile-logo-area d-lg-none d-flex justify-content-between align-items-center">
                  ...
                  <div className="menu-close-btn">
                    <i className="bi bi-x-lg" onClick={handleMobileMenu} />
                  </div>
                </div>
                <ul className="menu-list">
                  ...
                  >
                    <a
                      href="#"
                      className={
                        currentRoute === "/" ? "active drop-down" : "drop-down"
                      }
                    >
                      Home
                    </a>
                    ...
                    >
                      <li>
                        <Link href="/">
                          <a className={currentRoute === "/" ? "active" : "disabled"}>Home 01</a>
                        </Link>
                      </li>
                      <li>
                        <Link href="/index2">
                  ...
                  <li >
                    <Link  href="/about">
                      <a
                        className={
                          currentRoute === "/about" ? "active" : "disabled"
                        }
                      >
                        About Us
                      </a>
                  ...
                  >
                    <Link href="#">
                      <a
                        className={currentRoute === "/room-suits1" ||
                        currentRoute === "/room-suits2" ||
                        currentRoute === "/room-suits-details"?"active":"disabled"}
                      >
                        Suites
                      </a>
                    </Link>
                    ...
                    >
                      <li>
                        <Link href="/room-suits1">
                          <a className={currentRoute === "/room-suits1" ? "active" : "disabled"}>Room &amp; Suits 01</a>
                        </Link>
                      </li>
                      <li>
                        <Link href="/room-suits2">
                          <a className={currentRoute === "/room-suits2" ? "active" : "disabled"}>Room &amp; Suits 02</a>
                        </Link>
                      </li>
                      <li>
                        <Link href="/room-suits-details">
                          <a className={currentRoute === "/room-suits-details" ? "active" : "disabled"}>Room &amp; Suits Details</a>
                        </Link>
                      </li>
                    </ul>
                  </li>
                  ...
                  >
                    <Link href="#">
                      <a
                      className={currentRoute === "/hotel-facilities" ||
                      currentRoute === "/gallery" ||
                      currentRoute === "/faq"?"drop-down active":"drop-down"}
                    ...
                    >
                      <li>
                        <Link href="/hotel-facilities">
                          <a className={currentRoute === "/hotel-facilities" ? "active" : "disabled"} >Hotel Facilities</a>
                        </Link>
                      </li>
                      <li>
                        <Link href="/gallery">
                          <a className={currentRoute === "/gallery" ? "active" : "disabled"}>Gallery</a>
                        </Link>
                      </li>
                      <li>
                        <Link href="/faq">
                          <a className={currentRoute === "/faq" ? "active" : "disabled"}>Faq</a>
                        </Link>
                      </li>
                      <li>
                        <Link href="/404">
                  ...
                  >
                    <Link href="#">
                      <a
                        ...
                        className={ currentRoute === "/blog" ||
                        currentRoute === "/blog-sidebar" ||
                    ...
                    >
                      <li>
                        <Link href="/blog">
                          <a className={currentRoute === "/blog" ? "active" : "disabled"}>Blog Grid</a>
                        </Link>
                      </li>
                      <li>
                        <Link href="/blog-sidebar">
                          <a className={currentRoute === "/blog-sidebar" ? "active" : "disabled"}>Blog Sidebar</a>
                        </Link>
                      </li>
                      <li>
                        <Link href="/blog-standard">
                          <a className={currentRoute === "/blog-standard" ? "active" : "disabled"}>Blog Standard</a>
                        </Link>
                      </li>
                      <li>
                        <Link href="/blog-details">
                        
                          <a className={currentRoute === "/blog-details" ? "active" : "disabled"} >Blog Details</a>
                        </Link>
                      </li>
                    </ul>
                  </li>

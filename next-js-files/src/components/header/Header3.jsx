...
const initialState = { activeMenu: "" , mobileMenuState: false, };
      ...
      >
        ...
        <ul className="menu-list">
          ...
          >
            ...
            >
              <a className={currentRoute === "/index3" ? "drop-down active" : "drop-down"}>Home</a>
            </Link>
            <i
              className={
            ...
            >
              ...
              <li>
                <Link href="/index3">
                  <a className={currentRoute === "/index3" ? "active" : "disabled"}>Home 03</a>
                </Link>
              </li>
              <li>
                <Link href="/index4">
          ...
          >
            <a
              href="#"
              className={
                state.activeMenu === "pages" ? "active drop-down" : "drop-down"
              }
            >
              Pages
            </a>

...
function Header1() {
  ...
  return (
    <>
      <div className={currentRoute === "/" ? "top-bar" : "top-bar2"}>
        <div
          className={
            currentRoute === "/"
              ? "container-fluid"
              ...
              <div className="top-bar-items">
                ...
                {currentRoute === "/index2" ? (
                  <div className="top-bar-icon">
                    <Link href="/">
                     <a><img src="assets/images/header-logo2.svg" alt="" /></a>
                    </Link>
                  </div>
                ) : (
                  ""
                ...
                {
                  currentRoute === "/" ? (<div className="social-icon">
      ...
      <header className={currentRoute === "/"? "header-area style-1": currentRoute === "/index2"? "header-area style-2":""}>
        <div
        ...
        >
          ...
          <ul className="menu-list">
            ...
            >
              <Link href="#">
                <a className="active drop-down">Home</a>
              </Link>
              <i
                className={
        ...
        <div className="header-logo">
          <div className="logo-inner">
            <Link href="/">
             <a><img alt="image" src="assets/images/header-logo22.svg" /></a>
            </Link>
          </div>
        </div>

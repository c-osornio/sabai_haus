...
function reducer(state, action) {
  switch (action.type) {
    ...
    case "sidebarMenu":
      return { ...state, sidebarMenuState: action.isSidebarMenu };
    case "checkInDate":
...
function Header5() {
  ...
  return (
    <div className="hero-style5 d-flex align-items-start">
      <div
        className={
          state.sidebarMenuState == true ? "hero-sidebar slide" : "hero-sidebar"
        }
      >
        <div
          className="sidebar-close-btn d-xl-none d-block"
          onClick={() =>
            dispatch({ type: "sidebarMenu", isSidebarMenu: false })
          }
        >
        ...
        <div className="multi-main-searchber">
          <div className="searchbox-input date-picker-input">
            <ReactDatePicker
              ...
              onChange={(date) =>
                dispatch({ type: "checkInDate", checkInDate: date })
              }
          ...
          <div className="searchbox-input date-picker-input">
            <ReactDatePicker
              selected={state.date}
              onChange={(date) =>
                dispatch({ type: "checkOutDate", date: date })
              }
          ...
          <div className="main-form-submit pt-30">
            <a className=" btn--primary" href="room-suits1">
              Check Now
            </a>
          </div>
        </div>
      ...
      <div className="banner-area">
        <header className="header-area style-5">
          <div className="header-icon d-xl-none d-block">
            <img src="assets/images/header-logo2.svg" alt="" />
          </div>
          <div
            className={
                ...
                >
                  ...
                  <li>
                    <Link href="/index5">
                      <a
                        className={
                          currentRoute === "/index5" ? "active" : "disabled"
                        }
                      >
                        Home 05
                      </a>
          ...
          <div className="nav-right d-flex align-items-center">
            ...
            <div
              className="sidebar-btn d-xl-none d-block"
              onClick={() =>
                dispatch({ type: "sidebarMenu", isSidebarMenu: true })
              }
            >
        ...
        <div className="banner-content text-center">
          <h1>
            Discover Your Desire <span>Hotel Experience.</span>
          </h1>
          <Link href="/room-suits1">
            <a className="btn--primary6">Room &amp; Suites</a>
          </Link>
        </div>
      </div>
    </div>

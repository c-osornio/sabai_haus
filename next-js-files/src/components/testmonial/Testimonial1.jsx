              ...
              <SwiperSlide className="swiper-slide">
                <div className="testimonial-wrrap">
                  ...
                  <div className="content">
                    <p>
                      Curabitur magna nisi, egestas quis est in, finib Nunc
                      sitaa amet do odiotadin gone interdum, maximusonei offen
                      dolorbankon quis, ullamcor arcubl pellentesque foxthure
                      themego odio.{" "}
                    </p>
                  </div>
                  <div className="author-review-area d-flex justify-content-between align-items-center flex-erap">
                    <div className="authot-area d-flex align-items-center">
                      <div className="author-img">
                        <img
                          src="assets/images/bg/author-testimonial.png"
                          alt=""
                        />
                      </div>
                ...
                <div className="testimonial-wrrap">
                  ...
                  <div className="author-review-area d-flex justify-content-between align-items-center flex-erap">
                    <div className="authot-area d-flex align-items-center">
                      <div className="author-img">
                        <img
                          src="assets/images/bg/author-testimonial111.png"
                          alt=""
                        />
                      </div>
                      <div className="author-name-deg">
